...
| Nome | Hex | Uso |
|---|---|---|
| **Primary** | `#E85D2A` | CTAs, botões primários, destaques, links ativos. Laranja energético que remete à energia da corrida. |
| **Primary Dark** | `#C94D22` | Hover em botões primários, variante de ênfase. |
